#include "LUVPrimraryListController.h"

@implementation LUVPrimraryListController
...
- (void)viewDidLoad {
	...
	[[TDPrefsManager sharedInstance] initWithBundleID:@"com.TitanD3v.LuvPrefs" tweakName:@"Luv" prefsBundle:@"LuvPrefs.bundle"];

	[[TDPrefsManager sharedInstance] bannerTitle:@"Luv" subtitle:@"Coded with 🤍" devName:@"TitanD3v" coverImagePath:@"/Assets/Banner/cover-image.png" showCoverImage:YES iconPath:@"" iconTint:YES];
...
-(void)presentTutorialVC {
	...
	onboardingController = [[OBWelcomeController alloc] initWithTitle:@"User Guide" detailText:@"A walk through tutorial how to use Luv" icon:[[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/LuvPrefs.bundle/Assets/Banner/banner-icon.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
	...
	[onboardingController.buttonTray addCaptionText:@"Thank you for installing Luv"];
