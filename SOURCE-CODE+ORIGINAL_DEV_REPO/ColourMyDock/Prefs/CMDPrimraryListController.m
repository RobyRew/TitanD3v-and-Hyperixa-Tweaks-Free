#include "CMDPrimraryListController.h"

@implementation CMDPrimraryListController
...
- (void)viewDidLoad {
	...
	[[TDPrefsManager sharedInstance] initWithBundleID:@"com.TitanD3v.ColourMyDockPrefs" tweakName:@"ColourMyDock" prefsBundle:@"ColourMyDockPrefs.bundle"];

	[[TDPrefsManager sharedInstance] bannerTitle:@"ColourMyDock" subtitle:@"Coded with 🤍" devName:@"TitanD3v" coverImagePath:@"/Assets/Banner/cover-image.png" showCoverImage:YES iconPath:@"" iconTint:YES];

	[[TDPrefsManager sharedInstance] changelogPlistPath:@"/Assets/Changelog/changelog.plist" currentVersion:@"Version 2.0"];
...
-(void)presentTutorialVC {
	...
	onboardingController = [[OBWelcomeController alloc] initWithTitle:@"User Guide" detailText:@"A walk through tutorial how to use ColourMyDock" icon:[[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/ColourMyDockPrefs.bundle/Assets/Banner/banner-icon.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
	...
	[onboardingController addBulletedListItemWithTitle:@"Gesture" description:@"Choose your preferred gesture on the Dock to present dock settings menu." image:[UIImage systemImageNamed:@"hand.tap.fill"]];

	[onboardingController addBulletedListItemWithTitle:@"Border" description:@"Change the border width however you like." image:[UIImage systemImageNamed:@"line.horizontal.3.decrease"]];
	...
	[onboardingController.buttonTray addCaptionText:@"Thank you for installing ColourMyDock"];
