#include "PALPrimraryListController.h"

@implementation PALPrimraryListController
...
- (void)viewDidLoad {
	...
	[[TDPrefsManager sharedInstance] initWithBundleID:@"com.TitanD3v.PalettePrefs" tweakName:@"Palette" prefsBundle:@"PalettePrefs.bundle"];

	[[TDPrefsManager sharedInstance] bannerTitle:@"Palette" subtitle:@"Coded with 🤍" devName:@"TitanD3v" coverImagePath:@"/Assets/Banner/cover-image.png" showCoverImage:YES iconPath:@"" iconTint:YES];
...
-(void)presentTutorialVC {
	...
	onboardingController = [[OBWelcomeController alloc] initWithTitle:@"User Guide" detailText:@"A walk through tutorial how to use Palette" icon:[[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/PalettePrefs.bundle/Assets/Banner/banner-icon.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate]];
	...
	[onboardingController addBulletedListItemWithTitle:@"Gesture" description:@"Select your preferred gesture for status bar to invoke colour picker." image:[UIImage systemImageNamed:@"hand.tap.fill"]];
	...
	[onboardingController.buttonTray addCaptionText:@"Thank you for installing Palette"];
