...
@implementation SystemColourViewController
...
-(void)layoutTableView {
    ...
    self.colourArray = [[NSArray alloc]initWithContentsOfFile:[[NSBundle mainBundle] pathForResource: @"SystemColour" ofType: @"plist"]];
