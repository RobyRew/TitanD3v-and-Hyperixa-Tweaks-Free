...
@implementation BlackColourViewController
...
-(void)layoutTableView {
    ...
    self.colourArray = [[NSArray alloc]initWithContentsOfFile:[[NSBundle mainBundle] pathForResource: @"BlackColour" ofType: @"plist"]];
