...
@implementation GreenColourViewController
...
-(void)layoutTableView {
    ...
    self.colourArray = [[NSArray alloc]initWithContentsOfFile:[[NSBundle mainBundle] pathForResource: @"GreenColour" ofType: @"plist"]];
