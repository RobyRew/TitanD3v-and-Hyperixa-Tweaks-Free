...
-(void)layoutViews {
  ...
  [self.disableButton.leadingAnchor constraintEqualToAnchor:self.baseView.leadingAnchor constant:5].active = YES;
  ...
  [self.enableButton.trailingAnchor constraintEqualToAnchor:self.baseView.trailingAnchor constant:-5].active = YES;
  ...
  [self.titleLabel.topAnchor constraintEqualToAnchor:self.baseView.topAnchor constant:10].active = YES;


  self.percentageLabel = [[UILabel alloc] init];
  self.percentageLabel.textColor = [UIColor surgeFontColor];
  self.percentageLabel.font = [UIFont systemFontOfSize:10];
  self.percentageLabel.textAlignment = NSTextAlignmentLeft;
  [self.baseView addSubview:self.percentageLabel];

  self.percentageLabel.translatesAutoresizingMaskIntoConstraints = NO;
  [[self.percentageLabel centerXAnchor] constraintEqualToAnchor:self.baseView.centerXAnchor constant:15].active = true;
  [[self.percentageLabel centerYAnchor] constraintEqualToAnchor:self.baseView.centerYAnchor constant:5].active = true;


  self.battery = [[_UIBatteryView alloc] init];
  self.battery.showsInlineChargingIndicator = YES;
  [self.baseView addSubview:self.battery];
  ...
  [self.battery.centerYAnchor constraintEqualToAnchor:self.baseView.centerYAnchor constant:5].active = YES;
  [self.battery.centerXAnchor constraintEqualToAnchor:self.baseView.centerXAnchor constant:-15].active = true;
