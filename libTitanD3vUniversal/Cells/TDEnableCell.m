#import "TDEnableCell.h"

@implementation TDEnableCell
...
-(void)updatingValue {
	...
	isEnabled = [[settings objectForKey:self.specifier.properties[@"key"]]boolValue] ?: [self.specifier.properties[@"default"]boolValue];
...
-(void)enableAction {
	...
	[settings setObject:[NSNumber numberWithBool:YES] forKey:self.specifier.properties[@"key"]];
	[settings writeToFile:prefsPath atomically:YES];
