#include "PHXPrimraryListController.h"

@implementation PHXPrimraryListController
...
- (void)viewDidLoad {
	...
	[[TDPrefsManager sharedInstance] initWithBundleID:@"com.TitanD3v.PhoenixPrefs" tweakName:@"Phoenix" prefsBundle:@"PhoenixPrefs.bundle"];

	[[TDPrefsManager sharedInstance] bannerTitle:@"Phoenix" subtitle:@"Coded with 🤍" devName:@"TitanD3v" coverImagePath:@"/Assets/Banner/cover-image.png" showCoverImage:YES iconPath:@"/Assets/Banner/banner-icon.png" iconTint:NO];
...
-(void)presentTutorialVC {
	...
	onboardingController = [[OBWelcomeController alloc] initWithTitle:@"User Guide" detailText:@"A walk through tutorial how to use Phoenix" icon:[[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/PhoenixPrefs.bundle/Assets/Banner/banner-icon.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate]];
	...
	[onboardingController.buttonTray addCaptionText:@"Thank you for installing Phoenix"];
