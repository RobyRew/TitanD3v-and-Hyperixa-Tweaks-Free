...
- (void)drawRect:(CGRect)rect {
    ...
    if (alertTextFields.count > 0) {
        ...
        for (int i = 0; i < MIN(alertTextFields.count,4); i++) {
            ...
            tf.layer.borderColor = [[UIColor colorWithWhite:217.0f/255.0f alpha:0.3] CGColor];
            ...
            if (self.darkTheme)
                ...
                tf.backgroundColor = [UIColor colorNamed:@"Alert"];
...
{
    NSBundle *bundle = [NSBundle bundleWithURL:[[NSBundle bundleForClass:[self class]] URLForResource:@"AlertAssets" withExtension:@"bundle"]];
    return bundle;
}
