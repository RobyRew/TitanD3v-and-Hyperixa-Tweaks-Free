...
@implementation RedColourViewController
...
-(void)layoutTableView {
    ...
    self.colourArray = [[NSArray alloc]initWithContentsOfFile:[[NSBundle mainBundle] pathForResource: @"RedColour" ofType: @"plist"]];
