...
@implementation PurpleColourViewController
...
-(void)layoutTableView {
    ...
    self.colourArray = [[NSArray alloc]initWithContentsOfFile:[[NSBundle mainBundle] pathForResource: @"PurpleColour" ofType: @"plist"]];
