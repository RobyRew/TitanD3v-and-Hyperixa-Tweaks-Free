...
@implementation UninstallAppsViewController
...
-(void)layoutAccessoriesView {
  ...
  self.uninstallButton.backgroundColor = [UIColor appdataAccentColor];
...
-(void)presentUninstallConfirmation {
  ...
  UIAlertController * alertController = [UIAlertController  alertControllerWithTitle:@"Paradise" message:@"Are you sure you want to uninstall those Applications?" preferredStyle:UIAlertControllerStyleAlert];
...
-(void)uninstallApps {
  ...
  UIAlertController * alertController = [UIAlertController  alertControllerWithTitle:@"Paradise"
  message:message
