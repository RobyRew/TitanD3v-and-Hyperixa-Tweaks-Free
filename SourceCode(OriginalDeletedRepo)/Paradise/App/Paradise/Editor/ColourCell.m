...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.colourView.layer.cornerRadius = 5;
        self.colourView.layer.cornerCurve = kCACornerCurveContinuous;
        self.colourView.clipsToBounds = true;
        [self.baseView addSubview:self.colourView];
        
        [self.colourView size:CGSizeMake(40, 40)];
        [self.colourView x:self.baseView.centerXAnchor];
        [self.colourView bottom:self.titleLabel.topAnchor padding:-15];
