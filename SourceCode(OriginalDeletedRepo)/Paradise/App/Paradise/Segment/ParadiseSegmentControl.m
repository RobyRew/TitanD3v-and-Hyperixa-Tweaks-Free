...
@interface ParadiseSegmentControl ()
...
@implementation ParadiseSegmentControl
...
- (instancetype)init
{
  ...
  if (self) {
    ...
    [NSException raise:@"ParadiseSegmentControlInitException" format:@"Init call is prohibited, use initWithStringsArray: method"];
  }
...
{
  // to do
  return [[ParadiseSegmentControl alloc] initWithStringsArray:strings];
}
