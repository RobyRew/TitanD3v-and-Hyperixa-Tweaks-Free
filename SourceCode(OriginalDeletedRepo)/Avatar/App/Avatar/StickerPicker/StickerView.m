...
- (instancetype)initWithContentFrame:(CGRect)frame contentImage:(UIImage *)contentImage {
    ...
    if (self) {
        ...
        self.resizeControl.image = [UIImage imageNamed:@"btn_resize"];
        ...
        self.deleteControl.image = [UIImage imageNamed:@"btn_delete"];
...
- (void)initShapeLayer {
    ...
    [_shapeLayer setStrokeColor:[[UIColor systemBlueColor] CGColor]];
