...
@property (nonatomic) TDAlertViewControllerConfiguration *configuration;
...
- (instancetype)initWithConfiguration:(TDAlertViewControllerConfiguration *)configuration {
  self = [super init];
  ...
  if (self) {
    ...
    _messageTextView = [[TDAlertTextView alloc] initWithFrame:CGRectZero];
