#include "DGTPrimraryListController.h"

@implementation DGTPrimraryListController
...
- (void)viewDidLoad {
	...
	[[TDPrefsManager sharedInstance] initWithBundleID:@"com.TitanD3v.DigitneticPrefs" tweakName:@"Digitnetic" prefsBundle:@"DigitneticPrefs.bundle"];

	[[TDPrefsManager sharedInstance] bannerTitle:@"Digitnetic" subtitle:@"Coded with 🤍" devName:@"TitanD3v" coverImagePath:@"/Assets/Banner/cover-image.png" showCoverImage:YES iconPath:@"" iconTint:YES];
...
-(void)presentTutorialVC {
	...
	onboardingController = [[OBWelcomeController alloc] initWithTitle:@"User Guide" detailText:@"A walk through tutorial how to use Digitnetic" icon:[[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/DigitneticPrefs.bundle/Assets/Banner/banner-icon.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate]];
	...
	[onboardingController addBulletedListItemWithTitle:@"Enable Digitnetic" description:@"Enable Digitnetic then choose your prefered appearance." image:[UIImage systemImageNamed:@"1.circle.fill"]];

	[onboardingController addBulletedListItemWithTitle:@"Colour" description:@"You can colour digitnetic if you don't want to use light or dark mode." image:[UIImage systemImageNamed:@"2.circle.fill"]];

	[onboardingController addBulletedListItemWithTitle:@"Miscellaneous" description:@"You can set the calculator as primrary if you don't want it to show keypad first, change the corner radius and choose haptic feedback strength." image:[UIImage systemImageNamed:@"3.circle.fill"]];
	...
	[onboardingController.buttonTray addCaptionText:@"Thank you for installing Digitnetic"];
