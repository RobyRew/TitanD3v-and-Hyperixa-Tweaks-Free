...
@implementation DeviceUsageView
...
-(DeviceUsageAppearanceType)safeProgressAppearanceType:(NSInteger)progressAppearanceType{
  if(DeviceUsageAppearanceTypeOverlaysEmptyLine <= progressAppearanceType  && progressAppearanceType <= DeviceUsageAppearanceTypeUnderEmptyLine){
    return (DeviceUsageAppearanceType)progressAppearanceType;
  }

  return DeviceUsageAppearanceTypeOverlaysEmptyLine;
}
...
-(DeviceUsageLayer*)progressLayer{
  DeviceUsageLayer* layer = (DeviceUsageLayer*) self.layer;
  return layer;
}

+ (Class) layerClass {
  return [DeviceUsageLayer class];
}
